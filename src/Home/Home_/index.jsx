              ...
              <div className="banner-forms">
                <form className="banner-form">
                  <div className="input-group-form form-style form-br col-md-3 col-12"> <i className="fas fa-map-marker-alt text-warning" />
                    <input className="input-style-form" type="text" placeholder="Search Location" name="going" />
                  </div>
                  <div className="input-group-form form-style col-md-6 col-12"> 
                    <input className="input-style-form" type="text" placeholder="Search School, Online eductional centers, etc" name="going" />
                  </div>
                  <button className="btn button-form col-md-3 col-12" onClick={()=>this.searchmentee()} type="button">Search Now</button>
                </form>
              </div>
            </div>
                ...
                <div>
                  <div className="banner-card d-flex align-items-center">
                    ...
                    <div className="banner-contents">
                      ...
                      <a href="#">See all Locations <i className="fas fa-caret-right right-nav-white" /></a>
                    </div>
                  </div>
                </div>
                <div>
              ...
              <div className="col-md-4 col-lg-4 d-flex flex-wrap">
                <div className="allcourse-card">
                  ...
                  <div className="allcourse-content">
                    ...
                    <p>Over <span className="text-warning">2,500</span> Courses</p>
                  </div>
                </div>
              </div>
              <div className="col-md-4 col-lg-4 d-flex flex-wrap">
                <div className="allcourse-card">
                  ...
                  <div className="allcourse-content">
                    <h4 className="mb-3">Digital Marketer</h4>
                    <p>Over <span className="text-warning">5,500</span> Courses</p>
                  </div>
                </div>
              </div>
              <div className="col-md-4 col-lg-4 d-flex flex-wrap">
                <div className="allcourse-card">
                  ...
                  <div className="allcourse-content">
                    ...
                    <p>Over <span className="text-warning">2,540</span> Courses</p>
                  </div>
                </div>
              </div>
              <div className="col-md-4 col-lg-4 d-flex flex-wrap">
                <div className="allcourse-card">
                  ...
                  <div className="allcourse-content">
                    <h4 className="mb-3">IT Security</h4>
                    <p>Over <span className="text-warning">2,750</span> Courses</p>
                  </div>
                </div>
              </div>
              <div className="col-md-4 col-lg-4 d-flex flex-wrap">
                <div className="allcourse-card">
                  ...
                  <div className="allcourse-content">
                    ...
                    <p>Over <span className="text-warning">2,120</span> Courses</p>
                  </div>
                </div>
              </div>
              <div className="col-md-4 col-lg-4 d-flex flex-wrap">
                <div className="allcourse-card">
                  ...
                  <div className="allcourse-content">
                    ...
                    <p>Over <span className="text-warning">2,840</span> Courses</p>
                  </div>
                </div>
              </div>
